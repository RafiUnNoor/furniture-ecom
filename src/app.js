...
const productsDOM = document.querySelector('.products-center'),
  ...
  confirmCart = document.querySelector('.cart-item-confirm'),
...
const payCart = document.querySelector('.row');

confirmCart.addEventListener('click', showPay );
function showPay() {
  
  payCart.style.display = 'block';
  payCart.style.position = 'absolute';
  payCart.style.top = '0%';
} 